...
- 3-1: `Log_05.png`〜`Log_08.png`
- 3-2: `Log_09.png`〜`Log_10.png`（3-2を通った場合だけ追加）
- 5-1: `Log_11.png`〜`Log_24.png`
- 6-1: `Log_25.png`〜`Log_28.png`

## 巨人スタッフの対象STEP設定

`app.js`上部の`DESK_TASKS`へ、対象STEPと作業内容を追加します。
設定したSTEPから先へ進める時に依頼が発行されます。未設定のSTEPでは発行されません。
